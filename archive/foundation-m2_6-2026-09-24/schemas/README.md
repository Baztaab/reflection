...
- `ravi_vedic_core_v1.schema.json` — validated in CI against real development and
  ...
  per-body source methods and Swiss return-flag semantics, D1, D9 and D10. The contract
  rejects duplicate/missing Core Grahas, mismatched D9/D10 signatures, and impossible
  body/source/retflag combinations.
