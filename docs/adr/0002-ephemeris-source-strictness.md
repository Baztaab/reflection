...
The canonical production profile MUST require actual Swiss Ephemeris file output (`FLG_SWIEPH` present in returned flags) for ephemeris-backed bodies Sun through Saturn.
